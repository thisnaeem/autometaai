...
export class BgCreditManager {
  ...
  async getExpirationDate(): Promise<Date | null> {
    ...
    }) as { bgCreditsExpiresAt: Date | null } | null;
  ...
  async deductCredits(
    ...
    try {
      ...
      const result = await prisma.$transaction(async (tx) => {
        ...
        }) as { bgRemovalCredits: number } | null;
